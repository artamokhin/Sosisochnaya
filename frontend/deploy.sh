...
sudo tar xzvf ./sausage-store-${VERSION}.tar.gz /var/www-data/dist/sausage-store-${VERSION}.tar.gz||true #"<...>||true" говорит, если команда обвалится — продолжай#Обновляем конфиг systemd с помощью рестарта
